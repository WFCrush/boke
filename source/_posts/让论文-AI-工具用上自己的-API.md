...
description: >-
  ...
  bug」，顺带七条给后来者的铁律。
---
> 最近在折腾一款叫XX的桌面写作工具。它本质是个"AI 流水线"，把选题、检索、写作、配图、LaTeX 编译串起来，省去了大量手工活。但它有个让我极度不爽的设计——**模型供应商被锁死在OPEN AI官方中转站**。
>
...
- 配置存在 `AppData/Roaming/aris.db` 这个 SQLite 里。
